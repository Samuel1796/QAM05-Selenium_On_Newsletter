...
_This document describes the GitHub Actions workflow that runs the Selenium newsletter test suite. For a general overview of the project, see `README.md`._
